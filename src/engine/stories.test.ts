...
// month of the story's scenario, as computed by the real engine. The data
  ...
  for (const story of graph.stories) {
    describe(story.title, () => {
      const timeline = propagate(graph, {
        driverId: story.driver, phaseId: story.phase, startMonth: story.start_month, horizonMonths: 12,
      });
