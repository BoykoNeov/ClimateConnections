...
nodes:
  - id: enso                   # lowercase snake_case, unique, permanent
    ...
    default_start_month: 6     # drivers only, 1–12: the month "Event begins in" jumps to
                               # when this driver is picked (Indian Ocean basin February, Atlantic and Pacific meridional modes March, Atlantic Niño May, ENSO, IOD, SAM, AMO and the tropical eruption June, Barents–Kara ice October, PDO and QBO November, NAO December)
...
October for the Barents–Kara ice, November for the PDO and the QBO,
December for the NAO). A link with
