...
nodes:
  - id: enso                   # lowercase snake_case, unique, permanent
    ...
    default_start_month: 6     # drivers only, 1–12: the month "Event begins in" jumps to
                               # when this driver is picked (Indian Ocean basin February, Atlantic meridional mode March, Atlantic Niño May, ENSO, IOD, SAM and AMO June, PDO November, NAO December)
...
March for the Atlantic meridional mode, May for the Atlantic Niño, June
for ENSO, the IOD, the SAM and the AMO, November for the PDO, December for
the NAO). A link with
